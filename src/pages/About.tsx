    ...
    <section className="py-24 px-4">
      <div className="max-w-3xl mx-auto text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <p className="font-body text-base md:text-lg text-muted-foreground leading-relaxed mb-8">
            I'm <strong className="text-foreground">Nondumiso</strong>, the founder of Savor & Ore. I spent months perfecting the ratio of wild-crafted Sea Moss and potent adaptogens to create a cookie that tastes like an indulgence but works like a supplement.
          </p>
          <p className="font-body text-base md:text-lg text-muted-foreground leading-relaxed mb-8">
